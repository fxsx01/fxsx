...
─────────────────────`
    ...
    const mek2 =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 999, status: 200, thumbnail: fakeimagecuy, surface: 200, message: fakereply, orderTitle: fakereply1, sellerJid: '0@s.whatsapp.net'} } }              	 	         
...
case 'bneon':
		...
		case 'tagall2':
					...
					mentions(`┌───「MANCA TAG」───`+ teks +'└───「 *MANCA* 」────', members_id, true)
					break
		case 'clearall':
					if (!isOwner) return reply(ind.ownerb())
      ...
      case 'upswimg':
		...
		case 'simih':
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from, 'Sukses mengaktifkan mode simi di group ini ✔',MessageType.text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else if (Number(args[0]) === 0) {
						samih.splice(from, 1)
						fs.writeFileSync('./database/bot/simi.json', JSON.stringify(samih))
						client.sendMessage(from, 'Sukes menonaktifkan mode simi di group ini ✔',MessageType.text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else {
						reply(ind.satukos())
					}
					break
		case 'nsfw':
					...
					if (Number(args[0]) === 1) {
						...
						nsfw.splice(from, 1)
						fs.writeFileSync('./database/bot/nsfw.json', JSON.stringify(nsfw))
						client.sendMessage(from, 'Sukes menonaktifkan mode nsfw di group ini ✔',MessageType.text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else {
						reply(ind.satukos())
					}
					break
		...
		case 'welcome':
                 ...
                 case 'antilink':
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from, 'Sukses mengaktifkan anti link group di group ini ✔',MessageType.text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
						...
						fs.writeFileSync('./database/kelompok/antilink.json', JSON.stringify(antilink))
						client.sendMessage(from, 'Sukes menonaktifkan anti link group di group ini ✔',MessageType.text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else {
		...
		case 'clone':
                ...
                if (isGroup && !isCmd && isSimi && budy != undefined) {
						...
						console.log(color('[MANCA]','red'), 'Unregistered Command from', color(sender.split('@')[0]))
					}
					}
		} catch (e) {
