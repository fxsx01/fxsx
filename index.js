...
${fxsx} FdlXploit
╰──────────` 
faj = await getBuffer(ppnuy)
                    client.sendMessage(from, faj, image, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [num]}, displayname: mem, caption: fxsx })
					break
                  case 'addstic':
                case 'adds':
				    if (!isRegistered) return reply( ind.noregis())
